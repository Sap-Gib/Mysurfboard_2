...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AljAEQAEgsAHglQACgHABgGQALg8ARgpQAahAAngQQAVgJCBgjAq2AbQAwhAArgoQCJiABMCAQATAhAQAwAhiE8QFFlFB+EvQAHg1ALgqQAPg9AWgpQADgEACgEQAig4AwgQQAcgICsgj");
	this.shape.setTransform(0.025,0.025);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#663300").s().p("AAXG0IgBpyIAEgBQBCgSAxAAIAOAAIANABIAAAAQAZADAaAGQAeFigJEZgEgksAFMIgBpyIADgBQAhgJAdgFIA2gEIAHAAIAEAAIAOABQAZADAaAGIACAAQAeFjgJEYgEAhTADSIgBpyIADgBQAhgJAdgFIA1gEIAHAAIAKAAIAJABIA0AJIABAAQAeFkgJEXg");
	this.shape.setTransform(3.6392,75.6125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#339933").s().p("");
	this.shape_1.setTransform(0.0041,-28.2);
...
p.nominalBounds = new cjs.Rectangle(-261.8,-119.2,523.7,238.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#663300").s().p("AAXG0IgBpyIAEgBQBCgSAxAAQAOAAANABQAZADAaAGQAeFigJEZgEgksAFMIgBpyIADgBQAhgJAdgFIA2gEIAHAAIAUABQAZADAaAGQAeFigJEZgEAhTADSIgBpyIADgBQAhgJAdgFIA1gEIAHAAIAUABIA0AJQAeFkgJEXg");
	this.shape.setTransform(1.9392,75.6125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#339933").s().p("");
	this.shape_1.setTransform(0.0128,-28.2);
...
p.nominalBounds = new cjs.Rectangle(-262.2,-119.2,524.5,238.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#663300").s().p("AAXG0IgBpzQBYgYA6AHQAZADAaAGQAeFigJEZgEgksAFMIgBpzQBYgYA6AHQAZADAaAGQAeFigJEZgEAhTADSIgBpzQBYgYA5AHIA0AJQAeFkgJEXg");
	this.shape.setTransform(3.1892,75.6121);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#339933").s().p("");
	this.shape_1.setTransform(0.0166,-28.1756);
...
p.nominalBounds = new cjs.Rectangle(-261.8,-119.2,523.6,238.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFF33").ss(6,1,1).p("AJeoeIHMkFAMYANIIRAFADC0VIgiGfA0SnlIH9CMA0oEaIH/iFAqYyNIEFF+AAKNUIgEHCAJeJtIFzF4Ao+JyIlSFz");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_1.setTransform(54.7099,109.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF6633").s().p("ACfARQgKgDgDgGQgDgEABgEQgBgDADgEQADgGAKgEQAQgHAVAAQAWAAAPAHQAPAHABAKQgBAKgPAHQgPAIgWAAQgVAAgQgIgAjoARQgKgDgDgGQgDgEAAgEQAAgDADgEQADgGAKgEQAPgHAWAAQAWAAAPAHQAPAHABAKQgBAKgPAHQgPAIgWAAQgWAAgPgIg");
	this.shape_2.setTransform(57.55,51.45);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCC99").s().p("");
	this.shape_3.setTransform(56.75,48.925);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(0,153,255,0.498)").s().p("");
	this.shape_4.setTransform(62.8,191.2625);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#999999").s().p("");
	this.shape_5.setTransform(62.1896,147.1714);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000099").s().p("");
	this.shape_6.setTransform(61.135,111.6663);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_7.setTransform(54.7099,104.025);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#66FF66").s().p("");
	this.shape_8.setTransform(58.0411,97.6813);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("");
	this.shape_9.setTransform(57.3813,21.7375);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_1.setTransform(54.1957,109.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF6633").s().p("ACfARQgJgDgEgGQgCgEgBgEQABgDACgEQAEgGAJgEQAQgHAVAAQAWAAAPAHQAQAHAAAKQAAAKgQAHQgPAIgWAAQgVAAgQgIgAjoARQgJgDgEgGQgCgEAAgEQAAgDACgEQAEgGAJgEQAPgHAWAAQAWAAAPAHQAPAHAAAKQAAAKgPAHQgPAIgWAAQgWAAgPgIg");
	this.shape_2.setTransform(56.5,51.45);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCC99").s().p("");
	this.shape_3.setTransform(55.7,48.925);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(0,153,255,0.498)").s().p("");
	this.shape_4.setTransform(61.75,191.2625);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#999999").s().p("");
	this.shape_5.setTransform(61.1396,147.1714);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000099").s().p("");
	this.shape_6.setTransform(60.085,111.6663);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_7.setTransform(54.1957,104.725);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#66FF66").s().p("");
	this.shape_8.setTransform(56.9911,97.6813);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("");
	this.shape_9.setTransform(56.3313,21.7375);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_1.setTransform(54.5761,109.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF6633").s().p("ACfARQgJgDgEgGQgCgEAAgEQAAgDACgEQAEgGAJgEQAPgHAWAAQAWAAAPAHQAPAHAAAKQAAAKgPAHQgPAIgWAAQgWAAgPgIgAjoARQgJgDgEgGQgCgEgBgEQABgDACgEQAEgGAJgEQAQgHAVAAQAWAAAPAHQAQAHAAAKQAAAKgQAHQgPAIgWAAQgVAAgQgIg");
	this.shape_2.setTransform(57.25,51.45);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCC99").s().p("");
	this.shape_3.setTransform(56.45,48.925);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(0,153,255,0.498)").s().p("");
	this.shape_4.setTransform(62.5,191.2625);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#999999").s().p("");
	this.shape_5.setTransform(61.8896,147.1714);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000099").s().p("");
	this.shape_6.setTransform(60.835,111.6663);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_7.setTransform(54.5761,103.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#66FF66").s().p("");
	this.shape_8.setTransform(57.7411,97.6813);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("");
	this.shape_9.setTransform(57.0813,21.7367);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(0,0,0,0.729)").ss(0.1,1,1).p("AAxglIAAAxABbgqIAAA8AhagRIADA8Ag9gVIAAA4");
	this.shape_3.setTransform(609.85,241.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},225).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape_3}]},17).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape_3}]},1).wait(30));
...
(lib.Scene_1_grass2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// grass2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#339933").s().p("EhXyASDIAAjXMC5AAAAIAADXgEhkcgKYIAAnqUBm4AFtBiBgFtIAAHqg");
	this.shape.setTransform(637.025,556.2);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(273).to({_off:false},0).wait(148));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.wheelright();
	this.instance.setTransform(88.8,2.3,0.7719,0.8501,-150.0007,0,0,31.7,28.2);

	this.instance_1 = new lib.wheelright();
	this.instance_1.setTransform(-89.85,-0.6,0.7723,0.8505,-60.0098,0,0,32.2,30.1);
...
p.nominalBounds = new cjs.Rectangle(-125,-35.8,250,71.69999999999999);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.wheelright();
	this.instance.setTransform(90.6,-2.1,0.772,0.8502,-14.9992,0,0,31.2,28.5);

	this.instance_1 = new lib.wheelright();
	this.instance_1.setTransform(-89.35,-1.1,0.7724,0.8506,74.9914,0,0,32.3,30);
...
p.nominalBounds = new cjs.Rectangle(-122.8,-32.5,245.6,65);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.wheelright();
	this.instance.setTransform(93.2,0.7,0.7722,0.8503,104.9963,0,0,30.9,28.2);

	this.instance_1 = new lib.wheelright();
	this.instance_1.setTransform(-92.3,0.9,0.7725,0.8507,-165.0105,0,0,32.1,30.1);
...
p.nominalBounds = new cjs.Rectangle(-122.9,-32.5,245.9,65);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.wheelright();
	this.instance.setTransform(85,2.45,0.7723,0.8505,-135.0015,0,0,30.8,28.2);

	this.instance_1 = new lib.wheelright();
	this.instance_1.setTransform(-91.15,-0.1,0.7726,0.8507,-75.0106,0,0,32.2,30.1);
...
p.nominalBounds = new cjs.Rectangle(-122.8,-36.7,245.7,73.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.wheelright();
	this.instance.setTransform(90.95,0.55,0.7727,0.8509,0,0,0,33.4,29.9);

	this.instance_1 = new lib.wheelright();
	this.instance_1.setTransform(-89.05,-3.25,0.7729,0.851,0,0,0,32.8,29.3);
...
p.nominalBounds = new cjs.Rectangle(-114.6,-28.6,229.39999999999998,57.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(261.8,119.25);

	this.instance_1 = new lib.Tween12("synched",0);
	this.instance_1.setTransform(263.05,119.25);
	this.instance_1._off = true;

	this.instance_2 = new lib.Tween13("synched",0);
	this.instance_2.setTransform(261.35,119.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},9).to({state:[{t:this.instance_2}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:263.05},9).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},9).to({_off:true,x:261.35},9).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.6,0,525.9,238.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(5).to({regX:132.2,regY:129.9,rotation:59.9996},0).wait(4).to({regX:132,regY:129.8,rotation:144.7338,x:132.2,y:130.25},0).wait(6).to({regX:131.8,regY:129.9,rotation:241.7937,x:132.15},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-55.2,-56.7,374.3,373.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1242.35,378.25);
	this.instance._off = true;

	this.instance_1 = new lib.Tween19("synched",0);
	this.instance_1.setTransform(1125.8,374.8);
	this.instance_1._off = true;

	this.instance_2 = new lib.Tween20("synched",0);
	this.instance_2.setTransform(982.3,375.9);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween21("synched",0);
	this.instance_3.setTransform(848.3,377.9);
	this.instance_3._off = true;

	this.instance_4 = new lib.Tween31("synched",0);
	this.instance_4.setTransform(741.05,375.2);
	this.instance_4._off = true;

	this.instance_5 = new lib.Tween32("synched",0);
	this.instance_5.setTransform(741.05,375.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},453).to({state:[{t:this.instance_1}]},13).to({state:[{t:this.instance_2}]},10).to({state:[{t:this.instance_3}]},15).to({state:[{t:this.instance_4}]},14).to({state:[{t:this.instance_5}]},17).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(453).to({_off:false},0).to({_off:true,x:1125.8,y:374.8},13).wait(57));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(453).to({_off:false},13).to({_off:true,x:982.3,y:375.9},10).wait(47));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(466).to({_off:false},10).to({_off:true,x:848.3,y:377.9},15).wait(32));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(476).to({_off:false},15).to({_off:true,x:741.05,y:375.2},14).wait(18));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(491).to({_off:false},14).to({_off:true},17).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(910,364.4,1,1,0,0,0,261.8,119.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(273).to({_off:false},0).wait(148));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(42.25,0.65,0.6768,0.6768,14.9953,0,0,54.7,98.8);

	this.instance_1 = new lib.boy("synched",0);
	this.instance_1.setTransform(-56.2,0.85,0.6846,0.7037,0,0,0,56.8,93.7);
...
p.nominalBounds = new cjs.Rectangle(-95.8,-65.4,178.8,134.7);
...
(lib.Scene_1_boys_end = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(1245.5,265.8,1,1,0,0,0,0.2,0.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(453).to({_off:false},0).wait(1).to({regX:-0.2,x:1236,y:266.05,startPosition:1},0).wait(1).to({x:1226.95,y:266.35,startPosition:2},0).wait(1).to({x:1217.9,y:266.6,startPosition:3},0).wait(1).to({x:1208.8,y:266.9,startPosition:4},0).wait(1).to({x:1199.75,y:267.15,startPosition:5},0).wait(1).to({x:1190.7,y:267.45,startPosition:6},0).wait(1).to({x:1181.6,y:267.7,startPosition:7},0).wait(1).to({x:1172.55,y:268,startPosition:8},0).wait(1).to({x:1163.5,y:268.25,startPosition:9},0).wait(1).to({x:1154.4,y:268.55,startPosition:10},0).wait(1).to({x:1145.35,y:268.8,startPosition:11},0).wait(1).to({x:1136.3,y:269.1,startPosition:12},0).wait(1).to({x:1127.25,y:269.4,startPosition:13},0).wait(1).to({x:1113.45,startPosition:14},0).wait(1).to({x:1099.7,y:269.45,startPosition:15},0).wait(1).to({x:1085.95,startPosition:16},0).wait(1).to({x:1072.15,y:269.5,startPosition:17},0).wait(1).to({x:1058.4,startPosition:18},0).wait(1).to({x:1044.65,y:269.55,startPosition:19},0).wait(1).to({x:1030.85,startPosition:20},0).wait(1).to({x:1017.1,y:269.6,startPosition:21},0).wait(1).to({x:1003.35,startPosition:22},0).wait(1).to({x:989.6,y:269.65,startPosition:23},0).wait(1).to({x:980.95,y:269.6,startPosition:24},0).wait(1).to({x:972.3,y:269.55,startPosition:25},0).wait(1).to({x:963.7,startPosition:26},0).wait(1).to({x:955.05,y:269.5,startPosition:27},0).wait(1).to({x:946.4,startPosition:28},0).wait(1).to({x:937.8,y:269.45,startPosition:29},0).wait(1).to({x:929.15,y:269.4,startPosition:0},0).wait(1).to({x:920.5,startPosition:1},0).wait(1).to({x:911.9,y:269.35,startPosition:2},0).wait(1).to({x:903.25,startPosition:3},0).wait(1).to({x:894.6,y:269.3,startPosition:4},0).wait(1).to({x:886,y:269.25,startPosition:5},0).wait(1).to({x:877.35,startPosition:6},0).wait(1).to({x:868.7,y:269.2,startPosition:7},0).wait(1).to({x:860.1,startPosition:8},0).wait(1).to({x:852.1,startPosition:9},0).wait(1).to({x:844.15,startPosition:10},0).wait(1).to({x:836.2,startPosition:11},0).wait(1).to({x:828.25,startPosition:12},0).wait(1).to({x:820.3,startPosition:13},0).wait(1).to({x:812.35,startPosition:14},0).wait(1).to({x:804.4,startPosition:15},0).wait(1).to({x:796.45,startPosition:16},0).wait(1).to({x:788.5,startPosition:17},0).wait(1).to({x:780.55,startPosition:18},0).wait(1).to({x:772.6,startPosition:19},0).wait(1).to({x:764.65,startPosition:20},0).wait(1).to({x:756.7,startPosition:21},0).wait(1).to({x:748.75,startPosition:22},0).wait(1).to({y:269.15,startPosition:23},0).wait(1).to({startPosition:24},0).wait(1).to({startPosition:25},0).wait(1).to({y:269.1,startPosition:26},0).wait(1).to({startPosition:27},0).wait(1).to({startPosition:28},0).wait(1).to({startPosition:29},0).wait(1).to({y:269.05,startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({y:269,startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({y:268.95,startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:10},0).wait(1).to({startPosition:11},0).wait(1).to({y:268.9,startPosition:12},0).wait(1).to({startPosition:13},0).wait(1).to({startPosition:14},0).wait(1).to({y:268.85,startPosition:15},0).wait(1).to({startPosition:16},0).wait(1).to({startPosition:17},0).wait(1).to({startPosition:18},0).wait(1).to({y:268.8,startPosition:19},0).wait(1).to({startPosition:20},0).wait(1).to({startPosition:21},0).wait(1).to({startPosition:22},0).wait(1).to({y:268.75,startPosition:23},0).wait(1).to({startPosition:24},0).wait(1).to({startPosition:25},0).wait(1).to({startPosition:26},0).wait(1).to({y:268.7,startPosition:27},0).wait(1).to({startPosition:28},0).wait(1).to({startPosition:29},0).wait(1).to({startPosition:0},0).wait(1).to({y:268.65,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({y:268.6,startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({y:268.55,startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:10},0).wait(1).to({startPosition:11},0).wait(1).to({y:268.5,startPosition:12},0).wait(1).to({startPosition:13},0).wait(1).to({startPosition:14},0).wait(1).to({startPosition:15},0).wait(1).to({y:268.45,startPosition:16},0).wait(1).to({startPosition:17},0).wait(1).to({startPosition:18},0).wait(1).to({startPosition:19},0).wait(1).to({y:268.4,startPosition:20},0).wait(1).to({startPosition:21},0).wait(1).to({startPosition:22},0).wait(1).to({startPosition:23},0).wait(1));
...
(lib.Scene_1_boy2_car_middle = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Scene_1_boy_car_middle = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFCC33").s().p("AldBKIgrgXQgngWgkgbQgugigkgmIgWgaQgTgYgPgZIS6gBIAAABIAAgBIABAAIgBABIhHBaQgQAPgRAPIgIAHIgaAUQivCEjyANQjxgCiehHgAJdiSg");
...
if (reversed == null) { reversed = false; }
	...
	// boy2_car_middle_obj_
	this.boy2_car_middle = new lib.Scene_1_boy2_car_middle();
	this.boy2_car_middle.name = "boy2_car_middle";
	this.boy2_car_middle.setTransform(0,0.05,1.0343,1.0343,0,0,0,46.3,4.2);
	this.boy2_car_middle.depth = 0;
	this.boy2_car_middle.isAttachedToCamera = 0
	this.boy2_car_middle.isAttachedToMask = 0
	this.boy2_car_middle.layerDepth = 0
	this.boy2_car_middle.layerIndex = 6
	this.boy2_car_middle.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.boy2_car_middle).wait(292).to({regX:80.5,regY:6.2,scaleX:1.0908,scaleY:1.0908,y:-0.05},0).to({regX:78.8,regY:5,scaleX:1.0899,scaleY:1.0899,y:0.05},16).to({regX:77.9,regY:3.5,scaleX:1.0882,scaleY:1.0882,x:-0.05,y:0},15).to({regX:78.2,regY:0.7,scaleX:1.0842,scaleY:1.0842,x:0.05},19).to({regX:77.7,regY:3.6,scaleX:1.0935,scaleY:1.0935,x:0,y:0.05},17).to({regX:81.9,regY:7,scaleX:1.1875,scaleY:1.1875,x:0.05},26).to({regX:87.5,regY:5.5,scaleX:1.295,scaleY:1.295,x:0},8).to({_off:true},1).wait(173));

	// boy_car_middle_obj_
	this.boy_car_middle = new lib.Scene_1_boy_car_middle();
	this.boy_car_middle.name = "boy_car_middle";
	this.boy_car_middle.setTransform(0,0.05,1.0343,1.0343,0,0,0,46.3,4.2);
	this.boy_car_middle.depth = 0;
	this.boy_car_middle.isAttachedToCamera = 0
	this.boy_car_middle.isAttachedToMask = 0
	this.boy_car_middle.layerDepth = 0
	this.boy_car_middle.layerIndex = 7
	this.boy_car_middle.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.boy_car_middle).wait(292).to({regX:80.5,regY:6.2,scaleX:1.0908,scaleY:1.0908,y:-0.05},0).to({regX:78.8,regY:5,scaleX:1.0899,scaleY:1.0899,y:0.05},16).to({regX:77.9,regY:3.5,scaleX:1.0882,scaleY:1.0882,x:-0.05,y:0},15).to({regX:78.2,regY:0.7,scaleX:1.0842,scaleY:1.0842,x:0.05},19).to({regX:77.7,regY:3.6,scaleX:1.0935,scaleY:1.0935,x:0,y:0.05},17).to({regX:77.2,regY:6.5,scaleX:1.1021,scaleY:1.1021,x:0.05,y:-0.05},12).to({regX:81.9,regY:7,scaleX:1.1875,scaleY:1.1875,y:0.05},14).to({regX:87.5,regY:5.5,scaleX:1.295,scaleY:1.295,x:0},8).to({_off:true},1).wait(173));
	...
	// boys_end_obj_
	this.boys_end = new lib.Scene_1_boys_end();
	this.boys_end.name = "boys_end";
	this.boys_end.setTransform(0,0.05,1.0343,1.0343,0,0,0,46.3,4.2);
	this.boys_end.depth = 0;
	this.boys_end.isAttachedToCamera = 0
	this.boys_end.isAttachedToMask = 0
	this.boys_end.layerDepth = 0
	this.boys_end.layerIndex = 13
	this.boys_end.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.boys_end).wait(453).to({regX:141.4,regY:4.5,scaleX:1.6914,scaleY:1.6914,y:-0.05},0).wait(1).to({regX:996.9,regY:267.7,scaleX:1,scaleY:1,x:855.55,y:263.2},0).wait(113));
	...
	this.surfboard_end.layerIndex = 14
	...
	this.trees.setTransform(0,0.05,1.0343,1.0343,0,0,0,46.3,4.2);
	this.trees.depth = 0;
	this.trees.isAttachedToCamera = 0
	this.trees.isAttachedToMask = 0
	this.trees.layerDepth = 0
	this.trees.layerIndex = 15
	this.trees.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.trees).wait(273).to({regX:256.4,regY:39,scaleX:1.7058,scaleY:1.7058,x:0.1,y:0},0).to({_off:true},148).wait(146));

	// grass2_obj_
	this.grass2 = new lib.Scene_1_grass2();
	this.grass2.name = "grass2";
	this.grass2.setTransform(0,0.05,1.0343,1.0343,0,0,0,46.3,4.2);
	this.grass2.depth = 0;
	this.grass2.isAttachedToCamera = 0
	this.grass2.isAttachedToMask = 0
	this.grass2.layerDepth = 0
	this.grass2.layerIndex = 16
	this.grass2.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.grass2).wait(273).to({regX:256.4,regY:39,scaleX:1.7058,scaleY:1.7058,x:0.1,y:0},0).to({_off:true},148).wait(146));
	...
	this.surfboard_start.layerIndex = 29
	...
	this.waves_start.layerIndex = 30
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Animation_atlas_1.png?1619103546415", id:"Animation_atlas_1"},
		{src:"sounds/מיקיואליגלשןשירקיץילדיםשיריילדותישראליתmp3cutnet.mp3?1619103546588", id:"מיקיואליגלשןשירקיץילדיםשיריילדותישראליתmp3cutnet"}
	],
	preloads: []
};
